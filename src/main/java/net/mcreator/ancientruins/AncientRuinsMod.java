...
@Mod("ancient_ruins")
public class AncientRuinsMod {
	public static final Logger LOGGER = LogManager.getLogger(AncientRuinsMod.class);
	public static final String MODID = "ancient_ruins";

	public AncientRuinsMod() {
