...
import net.mcreator.ancientruins.item.model.ShardliterItemModel;
...
public class ShardliterItemRenderer extends GeoItemRenderer<ShardliterItem> implements RendersPlayerArms {
	public ShardliterItemRenderer() {
		super(new ShardliterItemModel());
	}

	@Override
	public RenderType getRenderType(ShardliterItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof ShardliterItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new ShardliterItemRenderer();
	...
	protected ShardliterItem animatable;
	...
	@Override
	public void render(GeoModel model, ShardliterItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(ShardliterItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(ShardliterItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(ShardliterItem animatable) {
