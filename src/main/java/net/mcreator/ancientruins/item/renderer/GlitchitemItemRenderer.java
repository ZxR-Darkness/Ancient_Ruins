package net.mcreator.ancientruins.item.renderer;
...
import net.mcreator.ancientruins.item.model.GlitchitemItemModel;
import net.mcreator.ancientruins.item.GlitchitemItem;
import net.mcreator.ancientruins.interfaces.RendersPlayerArms;
...
public class GlitchitemItemRenderer extends GeoItemRenderer<GlitchitemItem> implements RendersPlayerArms {
	public GlitchitemItemRenderer() {
		super(new GlitchitemItemModel());
	}

	@Override
	public RenderType getRenderType(GlitchitemItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof GlitchitemItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new GlitchitemItemRenderer();
	...
	protected GlitchitemItem animatable;
	...
	@Override
	public void render(GeoModel model, GlitchitemItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(GlitchitemItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(GlitchitemItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(GlitchitemItem animatable) {
